...
import (
	...
	"github.com/akurosia/mediamtx/internal/api"
	"github.com/akurosia/mediamtx/internal/auth"
	"github.com/akurosia/mediamtx/internal/conf"
	"github.com/akurosia/mediamtx/internal/confwatcher"
	"github.com/akurosia/mediamtx/internal/externalcmd"
	"github.com/akurosia/mediamtx/internal/logger"
	"github.com/akurosia/mediamtx/internal/metrics"
	"github.com/akurosia/mediamtx/internal/playback"
	"github.com/akurosia/mediamtx/internal/pprof"
	"github.com/akurosia/mediamtx/internal/recordcleaner"
	"github.com/akurosia/mediamtx/internal/rlimit"
	"github.com/akurosia/mediamtx/internal/servers/hls"
	"github.com/akurosia/mediamtx/internal/servers/moq"
	"github.com/akurosia/mediamtx/internal/servers/omt"
	"github.com/akurosia/mediamtx/internal/servers/rtmp"
	"github.com/akurosia/mediamtx/internal/servers/rtsp"
	"github.com/akurosia/mediamtx/internal/servers/srt"
	"github.com/akurosia/mediamtx/internal/servers/srtla"
	"github.com/akurosia/mediamtx/internal/servers/webrtc"
	"github.com/akurosia/mediamtx/internal/upgrade"
)
...
func (p *Core) createResources(initial bool) error {
	...
	if currentConf.SRTLA && currentConf.SRT && p.srtlaServer == nil {
		i := &srtla.Server{
	...
	if currentConf.OMT && p.omtServer == nil {
		i := &omt.Server{
			Address:             currentConf.OMTAddress,
			RTSPAddress:         currentConf.RTSPAddress,
			ReadTimeout:         currentConf.ReadTimeout,
			WriteTimeout:        currentConf.WriteTimeout,
			RunOnConnect:        currentConf.RunOnConnect,
...
func (p *Core) closeResources(newConf *conf.Conf) {
	...
	closeOMTServer := newConf == nil ||
		newConf.OMT != currentConf.OMT ||
		newConf.OMTAddress != currentConf.OMTAddress ||
		newConf.RTSPAddress != currentConf.RTSPAddress ||
		newConf.ReadTimeout != currentConf.ReadTimeout ||
		newConf.WriteTimeout != currentConf.WriteTimeout ||
		newConf.RunOnConnect != currentConf.RunOnConnect ||
