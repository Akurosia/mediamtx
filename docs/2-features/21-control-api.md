...
The control API is documented in the [Control API Reference page](../5-references/2-control-api.md) and in the [OpenAPI / Swagger file](https://github.com/akurosia/mediamtx/blob/{version_tag}/api/openapi.yaml).
